// ============================================================================
// PORT DATA — Extracted from WorldMonitor config/ports.ts
// 73 major world ports: container, oil, LNG, naval, mixed, bulk
// Includes strategic notes and TEU throughput rankings
// ============================================================================

export const PORTS = [
  // ═══ Top 20 Container Ports (ranked by TEU) ═══
  ...
  { id: 'port_gibraltar', name: 'Port of Gibraltar', lat: 36.14, lon: -5.35, country: 'UK (Gibraltar)', type: 'naval', note: 'Mediterranean-Atlantic gateway. UK naval base.' },
  { id: 'port_djibouti', name: 'Port of Djibouti', lat: 11.59, lon: 43.15, country: 'Djibouti', type: 'mixed', note: 'Bab el-Mandeb gateway. Chinese + US military bases.' },
  ...
  { id: 'bandar_abbas_port', name: 'Bandar Abbas', lat: 27.18, lon: 56.28, country: 'Iran', type: 'mixed', note: "Iran's largest container port. Hormuz Strait." },
  ...
  { id: 'zhanjiang_port', name: 'Zhanjiang Naval', lat: 21.20, lon: 110.40, country: 'China', type: 'naval', note: 'PLA Navy South Sea Fleet HQ. Carrier base.' },
  { id: 'yulin_port', name: 'Yulin Naval Base', lat: 18.23, lon: 109.52, country: 'China', type: 'naval', note: 'Hainan Island. Nuclear submarine base. SCS control.' },
  { id: 'vladivostok_port', name: 'Port of Vladivostok', lat: 43.12, lon: 131.88, country: 'Russia', type: 'naval', note: 'Russian Pacific Fleet HQ. Trans-Siberian terminus.' },
  { id: 'murmansk_port', name: 'Port of Murmansk', lat: 68.97, lon: 33.05, country: 'Russia', type: 'naval', note: 'Arctic ice-free port. Northern Fleet base.' },
  ...
  { id: 'chabahar_port', name: 'Chabahar', lat: 25.30, lon: 60.60, country: 'Iran', type: 'mixed', note: 'India-developed port. Hormuz bypass. Afghanistan access.' },
  ...
  { id: 'norfolk_port', name: 'Port of Virginia', lat: 36.95, lon: -76.33, country: 'USA', type: 'mixed', note: 'Adjacent to Norfolk Naval Base. 3M+ TEU.' },
  ...
  { id: 'lazaro_cardenas', name: 'Lazaro Cardenas', lat: 17.94, lon: -102.18, country: 'Mexico', type: 'mixed', note: "Mexico's 2nd largest. Asia-Mexico deep-water." },
...
/**
 * Port type → color mapping for map markers
 */
